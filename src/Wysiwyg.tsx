            ...
            if(quillObj) {
                ...
                if(range) {
                    ...
                    if(files && files[0]) {
                        ...
                        const fileNamePredecessor = currentdate.getDate().toString() + currentdate.getMonth().toString() + currentdate.getFullYear().toString() + currentdate.getTime().toString();
                        ...
                        if(response.ok) {
                            quillObj.getEditor().insertEmbed(range.index, 'image', `${API_BASE_URL}/images/${filename}`);
                        }
                    }
                }
            }
