...
export default function UsersTable({checkboxSelection, selectionModel, onSelectionModelChange, autoHeight, error, setError}: {checkboxSelection?: boolean, selectionModel?: GridInputSelectionModel, onSelectionModelChange?: (selectionModel: GridSelectionModel, details: GridCallbackDetails) => void, autoHeight?: boolean, error?: number, setError: (newError?: number) => void}) {
